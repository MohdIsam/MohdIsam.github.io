...
I designed and built a physical prototype to test the theory against real hardware rather than simulation alone with a scale locomotive chassis with a MOSFET driver stage, running on rail track, instrumented to collect performance data.
